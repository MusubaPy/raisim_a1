...
//    std::cout<<"Idx contact1 = "<<a1_->getBodyIdx("FL_calf")<<std::endl;
    ...
    if (visualizable_) 
    {
      ...
      a1_gui::init({a1_gui::video::init(vis->getResourceDir()),
                    ...
                    a1_gui::reward::init({"ClearAndSlip", "ForwardVel", "ForwardPos","BodyOrientation", "Velocity", "Torque", "BodyHeight"}),
                    a1_gui::frame::init()});
  ...
  float step(const Eigen::Ref<EigenVec>& action) final {
    ...
    a1_gui::reward::log("Torque", a1_->getGeneralizedForce().squaredNorm() * rewards_.getCoef("GenTorque"));
    a1_gui::reward::log("Velocity",a1_->getGeneralizedVelocity().squaredNorm() * rewards_.getCoef("GenVelocity"));
    a1_gui::reward::log("BodyOrientation", generalBodyOrientation * rewards_.getCoef("GeneralBodyOrientation"));
    a1_gui::reward::log("ForwardPos", gc_[0] * rewards_.getCoef("ForwardPos"));
    a1_gui::reward::log("ForwardVel", bodyLinearVel_[0] * rewards_.getCoef("ForwardVel"));
